...
class OEmbed extends MediaSourceBase implements OEmbedInterface {
  ...
  public function getMetadata(MediaInterface $media, $name) {
    ...
    switch ($name) {
      ...
      case 'thumbnail_uri':
        return $this->getLocalThumbnailUri($resource, $media->isMetadataUpdateEnforced()) ?: parent::getMetadata($media, 'thumbnail_uri');
   ...
   * more information.
   */
  protected function getLocalThumbnailUri(Resource $resource, $forceUpdate = FALSE) {
