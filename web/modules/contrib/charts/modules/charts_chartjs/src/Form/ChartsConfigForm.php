...
namespace Drupal\charts_chartjs\Form;
...
class ChartsConfigForm extends ConfigFormBase {
  ...
  public function getFormId() {
    return 'charts_chartjs_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return ['charts_chartjs.settings'];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('charts_chartjs.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('charts_chartjs.settings')
