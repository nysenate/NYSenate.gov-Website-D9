...
class ChartsPluginStyleChart extends StylePluginBase implements ContainerFactoryPluginInterface {
  ...
  public function render() {
    ...
    // '#title' => $this->options['title_position'] ? $this->options['title'] : FALSE,
      ...
      '#background' => isset($this->options['background']) ? $this->options['background'] : 'transparent',
      '#legend' => !empty($this->options['legend_position']),
      '#legend_position' => isset($this->options['legend_position']) ? $this->options['legend_position'] : NULL,
