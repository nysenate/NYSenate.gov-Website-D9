...
final class LocationMigration {
  ...
  public static function getGeolocationFieldName(string $field_name): string {
    return mb_substr($field_name, 0, FieldStorageConfig::NAME_MAX_LENGTH - mb_strlen(LocationMigration::GEOLOCATION_FIELD_NAME_SUFFIX));
  }
  ...
  public static function getEmailFieldName(string $field_name): string {
    return mb_substr($field_name, 0, FieldStorageConfig::NAME_MAX_LENGTH - mb_strlen(LocationMigration::EMAIL_FIELD_NAME_SUFFIX));
  }
  ...
  public static function getPhoneFieldName(string $field_name): string {
    return mb_substr($field_name, 0, FieldStorageConfig::NAME_MAX_LENGTH - mb_strlen(LocationMigration::PHONE_FIELD_NAME_SUFFIX));
  }
  ...
  public static function getFaxFieldName(string $field_name): string {
    return mb_substr($field_name, 0, FieldStorageConfig::NAME_MAX_LENGTH - mb_strlen(LocationMigration::FAX_FIELD_NAME_SUFFIX));
  }
  ...
  public static function getWwwFieldName(string $field_name): string {
    return mb_substr($field_name, 0, FieldStorageConfig::NAME_MAX_LENGTH - mb_strlen(LocationMigration::WWW_FIELD_NAME_SUFFIX));
  }
