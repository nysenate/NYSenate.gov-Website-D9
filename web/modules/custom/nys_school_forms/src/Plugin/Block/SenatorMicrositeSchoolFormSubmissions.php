 ...
 *   admin_label = @Translation("Senator Microsite School Form Submissions"),
...
class SenatorMicrositeSchoolFormSubmissions extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   * {@inheritdoc}
   */
  public function __construct(array $configuration, $plugin_id, $plugin_definition, SchoolFormsService $schoolFormsService, CacheBackendInterface $cache_backend, EntityTypeManagerInterface $entity_type_manager, CurrentRouteMatchInterface $current_route_match) {
