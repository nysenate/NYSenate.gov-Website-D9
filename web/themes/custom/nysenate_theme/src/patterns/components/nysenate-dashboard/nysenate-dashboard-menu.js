...
((Drupal) => {
  Drupal.behaviors.menuControl = {
    menuSelector: '.nysenate-dashboard-menu__dropdown',
    triggerSelector: '.nysenate-dashboard-menu__trigger',
    linkSelector: '.nysenate-dashboard-menu__link',
    dashboard: null,
    allItems: [],
    triggers: [],
    ...
    getDepth: function (item) {
      return item.dataset.dashboardDepth;
    },
    ...
    init: function (dashboard) {
      ...
      const menuItems = dashboard.querySelectorAll(`${this.triggerSelector}, ${this.linkSelector}`);
    ...
    attach: function (context) {
      const dashboards = once('senateDashboardMenu', '.nysenate-dashboard', context);
